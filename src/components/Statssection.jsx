        ...
        <section ref={ref} className="py-16 bg-white dark:bg-gray-950 w-full transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-6xl font-medium font-sans bg-linear-to-t from-neutral-500 to-neutral-800 bg-clip-text text-transparent tracking-tight dark:text-white mb-6 transition-colors">
                        {t.systemImpact}
                    </h2>
                    <p className="text-lg text-gray-800 dark:text-gray-300 max-w-xl mx-auto transition-colors">
                        {t.impactDesc}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center group"
                        >
                            ...
                            <div className="text-4xl font-semibold text-gray-800 dark:text-white mb-1 transition-colors">
                                {inView ? (
                                    <CountUp
                                        end={stat.value}
                                        duration={2.5}
                            ...
                            <h3 className="text-lg font-semibold-gray-800 dark:text-gray-200 mb-2 transition-colors">
                                {stat.label}
                            </h3>
